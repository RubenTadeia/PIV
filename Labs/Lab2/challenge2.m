...
u3 =[530 486 471 442 413]';
v3 =[194 270 329 287 359]';
u4=[153 85 122 27 57]';
v4=[196 268 337 277 373]';
% figure(7);hold on;plot(u3,v3,'*r');hold off;
% figure(9);hold on;plot(u4,v4,'*r');hold off;
...
T2=cent3-R23*cent4;
xyzt3=(R23*(xyzt12-repmat(cent3,1,length(xyzt12))));%Estou a juntar a pointCould2 à pointCloud3 no ref 3!
